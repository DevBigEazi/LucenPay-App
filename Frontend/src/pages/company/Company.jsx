                ...
                return (
                  <Card key={id} className="company-team-card">
                    ...
                    <div className="company-team-socials">
                      ...
                      <a href="https://web.facebook.com/" target="_blank" rel="noopener noreferrer">{twitter}</a>
                      <a href="https://web.facebook.com/" target="_blank" rel="noopener noreferrer">{linkedin}</a>
                    </div>
                  </Card>
                )
              })
